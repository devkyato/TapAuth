...
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS student_no VARCHAR(64) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS lastname VARCHAR(100) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS firstname VARCHAR(100) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS middlename VARCHAR(100) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS fullname VARCHAR(255) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS course VARCHAR(100) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS project_type VARCHAR(100) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS room VARCHAR(100) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS nfc_code VARCHAR(128) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.users ADD COLUMN IF NOT EXISTS created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE \`$DB_NAME\`.user_logs ADD COLUMN IF NOT EXISTS nfc_code VARCHAR(128) NOT NULL DEFAULT '';
ALTER TABLE \`$DB_NAME\`.user_logs ADD COLUMN IF NOT EXISTS date_logged TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
